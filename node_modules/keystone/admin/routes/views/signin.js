...
exports = module.exports = function(req, res) {
	...
	if (req.method === 'POST') {
		...
		if (!req.body.email || !req.body.password) {
			req.flash('error', 'Por favor ingresa correo electrónico y contraseña.');
			return renderView();
		}
		...
		var onFail = function (err) {
			var message = (err && err.message) ? err.message : 'Lo sentimos correo electronico y contraseña incorrectos.';
